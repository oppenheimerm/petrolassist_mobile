...
//  TODO - MAKE STATEFULL
//  need to usr futue builder te get user current location

class TripConfirmationWidget extends StatelessWidget {
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Container( width: 16,),
                                        Text(
                                          Utils.truncateText(startAddress, 36),
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Container( width: 16,),
                                        Text(
                                            Utils.truncateText(stationAddress, 36),
                                          style: Theme.of(context).textTheme.headlineSmall
                                        ),
                                      ],
                                    ),
                                ...
                                SizedBox(
                                  ...
                                  child: ElevatedButton(
                                      ...
                                      onPressed: () async {
                                        ...
                                        await homeViewModel.drawPolyLinesForTrip(
